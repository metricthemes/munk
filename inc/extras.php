...
if( !function_exists('munk_pagination_ed') ) {
    ...
    switch( $pagination ){
        ...
        the_posts_pagination( array(
          'screen_reader_text' => ' ',
          'prev_text' => __( 'Previous', 'munk' ),
          'next_text' => __( 'Next', 'munk' ),
          ) );
...
function munk_footer_credit(){
    ...
    $text .= '<a href="' . esc_url( 'https://metrichemes.com/theme/munk/' ) .'" target="_blank">' . esc_html__( 'Built with Munk', 'munk' ) .'</a>. '; /* translators: %s: wordpress.org URL */ 
	}
