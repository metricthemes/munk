...
function munk_color_button_settings( $config ) {
	...
	Kirki::add_field( 'munk',  array(
		...
		'output'    => array(
			array(
			  'choice'    => 'bgcolor',
			  'element'   => '.navigation.pagination .nav-links a:hover,.navigation.pagination .nav-links .current, .no-results .search-submit, .woocommerce div.product .cart .single_add_to_cart_button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt,.wp-block-button__link,.is-style-outline .wp-block-button__link, .woocommerce-page ul.products li.product .button, .woocommerce ul.products li.product .button, .woocommerce-js.woocommerce ul.products li.product .button, .wc-block-grid__product .wp-block-button__link',
			...
			array(
			  'choice'    => 'hover-bg',
			  'element'   => '.navigation.pagination .nav-links a:hover,.navigation.pagination .nav-links .current, .woocommerce div.product .cart .single_add_to_cart_button:hover, .woocommerce #respond input#submit.alt:hover, .woocommerce a.button.alt:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover,.wp-block-button__link:hover,.is-style-outline .wp-block-button__link:hover, .woocommerce-page ul.products li.product .button:hover, .woocommerce ul.products li.product .button:hover, .woocommerce-js.woocommerce ul.products li.product .button:hover, .wc-block-grid__product .wp-block-button__link:hover',
			  'property'  => 'background-color',
			),
			array(
				'choice'    => 'hover-bg',			
	...
	Kirki::add_field( 'munk',  array(
		...
		'output'    => array(
			...
			array(
			  'choice'    => 'bgcolor',
			  'element'   => '.entry-card .read-more a,#respond .form-submit #submit, .woocommerce #respond input#submit.alt, .no-results .search-submit,.woocommerce-page ul.products li.product .added_to_cart, .woocommerce ul.products li.product .added_to_cart, .woocommerce-js.woocommerce ul.products li.product .added_to_cart,.wc-block-grid__product a.added_to_cart, .woocommerce a.button',
			  'property'  => 'border-color',
			),			
			array(
			  'choice'    => 'text',
			...
			array(
			  'choice'    => 'hover-bg',
			  'element'   => '.entry-card .read-more a:hover, #respond .form-submit #submit:hover, .woocommerce #respond input#submit.alt:hover, .no-results .search-submit:hover,.woocommerce-page ul.products li.product .added_to_cart:hover, .woocommerce ul.products li.product .added_to_cart:hover, .woocommerce-js.woocommerce ul.products li.product .added_to_cart:hover,.wc-block-grid__product a.added_to_cart:hover, .woocommerce a.button:hover',
			  'property'  => 'background-color',
			),
			array(
			  'choice'    => 'hover-text',
